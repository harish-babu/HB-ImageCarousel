...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carouselItems.add(new ImageModel("https://picsum.photos/id/12/600/400", ""));
        carouselItems.add(new ImageModel("https://picsum.photos/id/16/600/400", ""));
        carouselItems.add(new ImageModel("https://picsum.photos/id/18/600/400", ""));
        carouselItems.add(new ImageModel("https://picsum.photos/id/20/600/400", ""));
        carouselItems.add(new ImageModel("https://picsum.photos/id/22/600/400", ""));
